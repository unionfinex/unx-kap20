...
contract KAP20 is KAP20Detailed {
    ...
    function transferOwnership(address newOwner) public {
        require(msg.sender == owner(), "KAP20: caller is not the owner");
        _setOwner(newOwner);
    ...
    function transfer(address recipient, uint256 amount) public returns (bool) {
        require(!_getBlackList(msg.sender), "KAP20: the sender is blacklisted");
    ...
    function transferFrom(address sender, address recipient, uint256 amount) public returns (bool) {
        require(!_getBlackList(sender), "KAP20: the sender is blacklisted");
